    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:form class="form-horizontal" controller="documentResource" action="checkMultipleList">
                    ...
                    <div class="form-group">
                        ...
                        %{--</div>--}%
                        <g:select name="topics" from="${listOfTopics}" optionKey="id" multiple="yes"
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10" style="float:left">
                            <g:actionSubmit value="submit" action="checkMultipleList"
