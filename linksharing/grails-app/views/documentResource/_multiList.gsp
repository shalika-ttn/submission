    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:uploadForm  class="form-horizontal" controller="documentResource" action="multiListCheck" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <g:select name="id" from="${listOfTopics}" optionKey="id" multiple="yes"
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10" style="float:left">
                            <g:actionSubmit value="submit" action="multiListCheck"
