<%@ page import="com.ttnd.linksharing.Enum.Visiblity; com.ttnd.linksharing.Enum.Seriousness" %>
<div class=row>
...
<div class=row>
    ...
    <div align="center" style="margin-left:100px">
        <div class="col-xs-4">
            ...
            <g:select name="visibility" from="${Visiblity.values()}" value="${Visiblity.PRIVATE}"
                      noSelection="['': 'visibilty']"/>
        </div>

        <div class="col-xs-3">


            <g:select name="seriousness" from="${Seriousness.values()}" value="${Seriousness.SERIOUS}"
                      noSelection="['': 'seriousnes']"/>
